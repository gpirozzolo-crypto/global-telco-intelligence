...
from ingest.arcep_deployment import load_arcep_deployment
...
def arcep_deployment_load(): print(json.dumps({"source":"ARCEP_OBS","dataset":"deployment",**load_arcep_deployment(context())}))
